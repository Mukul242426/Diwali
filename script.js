(function () {
  HTMLElement.prototype.fireworks = function (options) {
    options = options || {};
    options.sound = options.sound || false;
    options.opacity = options.opacity || 1;
    options.width = options.width || this.clientWidth;
    options.height = options.height || this.clientHeight;

    var canvas = document.createElement("canvas");
    canvas.id = "fireworksField";
    var SCREEN_WIDTH = options.width;
    var SCREEN_HEIGHT = options.height;
